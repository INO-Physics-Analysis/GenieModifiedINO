...
public :
 ...
 ~GMCJDriver();
  ...
  double  ComputeTotalEvent(int idummy, double&, double&);    //*GMA
  double 	rateofevents;			                                  //*GMA
  int 		total_norm;		                                     	//*GMA
  bool 		ratecalflag;		                                    //*GMA
  double	totalflux;		                                     	//*GMA
  double	tenpower;	                                       		//*GMA
  bool    partOrTotal;                                        //*GMA
  //  double 	rateofevents_enu[101];		                    	//*GMA
  //  double		norm[101];	                                  //*GMA
