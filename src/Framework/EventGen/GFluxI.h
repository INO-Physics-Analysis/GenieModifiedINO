...
public :
  ...
  virtual double                 FluxWeight    (void) = 0; ///< returns the flux of chosen neutrino nup4	//*GMA
  ...
  virtual double                 AtmoEnergyWeight(void) = 0;   //*GMA
  virtual void                   nu_EnergyBin(int& nbin, double* lowerbins) =0;  //*GMA
