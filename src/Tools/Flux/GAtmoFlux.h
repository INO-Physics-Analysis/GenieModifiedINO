...
public :
  ...
  virtual double                 FluxWeight    (void) { return  fFluxWeight;} 	//*GMA
  ...
  void     ForceEnergyWeight  (double wt=0);                        //*GMA
  virtual double AtmoEnergyWeight (void) {return fEnergyWeight;}    //*GMA
  void nu_EnergyBin(int& nbin, double* lowerbins);                  //*GMA
protected:
  ...
  double 	         fEnergyWeight;	      ///power of energy applied to flux for weighted events		//*GMA
  double           fFluxWeight;         ///< fluxvalue of the chosen bin		//*GMA
};
